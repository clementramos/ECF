...
if(isset($_GET['search']) AND !empty($_GET['search'])){
    ...
    $getAllHotels = $bdd->query('SELECT etablissement_id, etablissement_title, etablissement_city, etablissement_adress, etablissement_description, etablissement_date FROM etablissements WHERE etablissement_title LIKE "%'.$usersSearch.'%" ORDER BY etablissement_id DESC');
